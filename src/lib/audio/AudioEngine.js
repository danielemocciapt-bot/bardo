...
export class AudioEngine {
  ...
  /**
   * @param {AudioRef} ref
   * Loop NATIVO (attributo loop dell'elemento). Per la musica è html5:true: il
   * loop lo fa il motore multimediale, quindi continua anche a schermo spento
   * (i timer JS si congelano in background, un loop a mano NON ripartirebbe).
   * Il seam del loop è reso liscio dal crossfade coda->testa bakato nel file.
   */
